      ...
      <div class="container">
        <div class="row align-items-stretch retro-layout-2">
          <div class="col-md-4">
            ...
            <a href="{{url('/post/'. $fPost->slug)}}" class="h-entry mb-30 v-height gradient" style="background-image: url('{{$fPost->image}}');">
          ...
          @foreach($lastPost as $lPost)
            <a href="{{url('/post/'. $fPost->slug)}}" class="h-entry mb-30 v-height gradient" style="background-image: url('{{$lPost->image}}');">
          ...
          <div class="col-lg-4 mb-4">
            <div class="entry2">
              ...
              <div class="post-meta align-items-center text-left clearfix mb-2">
                <span class="d-inline-block mt-1">By <a href="{{url('single', $recentPost->user_id)}}">{{$recentPost->user->name}}</a></span>
